...
stop_words = {
    "من", "في", "على", "إلى", "عن", "أن", "إن", "لن", "لم", "قد", "هو", "هي", "هم", "ها",
    "كان", "كانت", "يكون", "تكون", "ما", "لا", "كل", "هذا", "هذه", "ذلك", "تلك", "أو",
    "أي", "إذ", "ثم", "بين", "بعد", "قبل", "مع", "حتى", "إذا", "وقد", "فقد",
    # كلمات قانونية عامة مكررة لا تدل على نوع القضية
    "القاضي", "محكمة", "المحكمة", "الدائرة", "القانون", "المادة", "مادة", "رقم", "رئيس", "رئيساً",
    "العدالة", "الشرعية", "المدعي", "المدعى", "المطعون", "الطاعن", "الحكم", "الحكمة", "قانون"
}
